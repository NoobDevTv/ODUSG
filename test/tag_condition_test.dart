...
void main() {
  ...
  void doParseTest(
    ...
    final res1 = const DeepCollectionEquality().equals(
      parsed.operators,
      tagOperators,
    );
    final res2 = const DeepCollectionEquality().equals(
      parsed.conditionOperators,
      conditionOperators,
    );
    final res3 = const DeepCollectionEquality().equals(
      parsed.operands,
      operands,
    );
    expect(res1, true);
  ...
  group('Complex Tests', () {
    parameterizedTest('Tests single and and or combinations and condition', [
      [
    ...
    parameterizedTest('Tests and or combinations and condition', [
      [
  ...
  group('Parse Evaluate With Tags', () {
    parameterizedTest('String Parsing Success', [
      ...
      ["player.alive < 5", <String, int>{}, true],
      [
        "player.alive < 11",
        {"player.alive": 10},
        true,
  ...
  group('Simple Conditions', () {
    parameterizedTest('Tests simple less condition', [
      [
        [TagOperator.less],
        <ConditionOperator>[],
        <dynamic>[1, 2],
      ...
      [<TagOperator>[], <ConditionOperator>[], <dynamic>[], true],
    ], doTest);

    parameterizedTest('Tests simple greater condition', [
      [
        [TagOperator.greater],
        <ConditionOperator>[],
        <dynamic>[1, 2],
    ...
    parameterizedTest('Tests simple equal condition', [
      [
        [TagOperator.equals],
        <ConditionOperator>[],
        <dynamic>[1, 2],
