...
const textEvents = [
  ...
  EventInfo([EventText("Spieler {good_1} ist einer der guten")]),
  EventInfo([
  ...
  SingleSelectionEvent(<int, List<EventText>>{
    0: [EventText("Wen möchtest du?")],
    1: [
      EventText(
        "Spieler {selected_1} ausgewählt, er ist gut",
        tags: Tags([Tag("Role.good")]),
      ),
      EventText(
        "Spieler {selected_1} ausgewählt, er ist böse",
        tags: Tags([Tag("Role.bad")]),
      ),
    ],
  }),
  TagEvent([
